...
export default function PrivacyPolicy() {
  return (
    <main className="max-w-4xl mx-auto p-6 text-gray-800 dark:text-gray-200">
      ...
      <div className="prose dark:prose-invert max-w-none space-y-10 text-sm md:text-base leading-relaxed">
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">1. 個人情報の利用目的</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">2. 広告について</h2>
          <p>
            当ブログでは、第三者配信の広告サービス（Googleアドセンス、A8.net、もしもアフィリエイトなど）を利用しており、ユーザーの興味に応じた商品やサービスの広告を表示するため、クッキー（Cookie）を使用しております。<br />
        ...
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">3. アクセス解析ツールについて</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">4. 免責事項</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">5. 著作権について</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold mb-4 border-l-4 border-blue-500 pl-3">6. リンクについて</h2>
          <p>
